...
exports.decodeCliResponse = exports.encodeCliRequest = void 0;
...
const encodeCliRequest = (req) => {
    const corr = (0, remp_1.uuidToBytes)(req.corrId);
...
exports.encodeCliRequest = encodeCliRequest;
const decodeCliResponse = (payload) => {
    ...
    const corrId = (0, remp_1.bytesToUuid)(payload.subarray(4, 20));
...
exports.decodeCliResponse = decodeCliResponse;
